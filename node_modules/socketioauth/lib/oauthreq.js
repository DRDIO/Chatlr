...
module.exports = function(server, config, redirectCallback)
{
    var callbackUrl = config.domain + '/callback',
        oa = new oauth.OAuth(config.requestUrl, config.accessUrl, config.consumerKey, config.consumerSecret, '1.0', callbackUrl, 'HMAC-SHA1');
